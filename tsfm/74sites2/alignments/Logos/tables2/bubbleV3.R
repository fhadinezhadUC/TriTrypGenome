...
#TableDir <- "/home/fatemeh/TriTrypGenome/tsfm/74sites2/alignments/Logos/tables2/MAJOR_Table.txt"
# tables <- list.files(path = TableDir,pattern = "_Table.txt", recursive = FALSE)
# # TableDir <- "/home/fatemeh/doc/DavesTable/"
# # tables <- list.files(path = TableDir,pattern = "_table.txt", recursive = FALSE)
# 
# # sort tables based on this array: 
# orders <- c(5, 6, 8, 2, 7, 1, 3, 4)
# tables <- tables[order(orders)]
# 
# ldf.74 <- list()
...
# }
MAJOR.74       <- read.table("/home/fatemeh/72sitesMiller_max5/tables_74sites_Miller_max5/MAJOR_Table.txt",header=T);
INFANTUM.74    <- read.table("/home/fatemeh/72sitesMiller_max5/tables_74sites_Miller_max5/INFANTUM_Table.txt",header=T);
MEXICANA.74    <- read.table("/home/fatemeh/72sitesMiller_max5/tables_74sites_Miller_max5/MEXICANA_Table.txt",header=T);
VIANNIA.74     <- read.table("/home/fatemeh/72sitesMiller_max5/tables_74sites_Miller_max5/VIANNIA_Table.txt",header=T);
ENRIETTII.74   <- read.table("/home/fatemeh/72sitesMiller_max5/tables_74sites_Miller_max5/ENRIETTII_Table.txt",header=T);
LEPTOCRITH.74  <- read.table("/home/fatemeh/72sitesMiller_max5/tables_74sites_Miller_max5/LEPTOCRITH_Table.txt",header=T);
AFTRYP.74      <- read.table("/home/fatemeh/72sitesMiller_max5/tables_74sites_Miller_max5/AFTRYP_Table.txt",header=T);
AMTRYP.74      <- read.table("/home/fatemeh/72sitesMiller_max5/tables_74sites_Miller_max5/AMTRYP_Table.txt",header=T);
ldf.74   <- list(MAJOR.74,INFANTUM.74,MEXICANA.74,VIANNIA.74,AFTRYP.74,AMTRYP.74,LEPTOCRITH.74,ENRIETTII.74);
classes  <- c('L','I','V','R','C','M','E','Q','Y','W','S','T','P','H','G','D','N','K','F','A','X');
