...
\textbf{Input}: output is saved in latex format in this file \href{}{SummaryTable_Latex.txt}
\textbf{Input}: output is saved in latex format in this file \href{}{GenomeNucComposition_Latex.txt}
