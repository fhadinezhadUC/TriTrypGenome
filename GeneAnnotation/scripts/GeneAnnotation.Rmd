...
Read the annotated gene file (output of function annotate.final.geneset.round1), removes genes with ambiguty marked as # (35 genes), genes with function Sec (76 genes) and genes from two genomes genes of genomes TrangeliSC58 and TcruziCLBrener and writes the selected genes in file tsfm_input_geneset.txt (17 genes).\
tsfm_input_geneset.txt file should be used for further alignment.\
