...
\textbf{Input}: \textbf{tsfm\_input\_geneset.txt}\
...
\textbf{Input}: \textbf{GenomeNucComposition.txt} and \textbf{output of function annotate.final.geneset.round1\(\)}\
...
\textbf{Input}: output of function annotate.final.geneset.round1()\
\textbf{Output}: \textbf{tsfm\_input\_geneset.txt}\
